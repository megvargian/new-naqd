                ...
                <div class="justify-content-between align-items-center lower-part py-2 w-100">
                    ...
                    <div>
                        <p class="helvetica-regular" dir="ltr">
                            <svg class="heart" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 471.701 471.701" xml:space="preserve" stroke="#fff">
                        ...
                        <!-- <img class="heart" src="<?php //echo get_template_directory_uri(); ?>/inc/assets/icons/heart.svg" alt="heart"> -->
                            <svg class="heart-filled d-none" xmlns="http://www.w3.org/2000/svg" fill="#fff" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" stroke="#fff">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
